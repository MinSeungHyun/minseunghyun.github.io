...
{% include image.html src="/assets/images/post/3/1.png" %}
`첫 번째 캠페인 만들기` 버튼을 클릭합니다.

### 3-1 스타일 및 콘텐츠 설정
{% include image.html src="/assets/images/post/3/2.png" %}
먼저 메시지 레이아웃을 설정해줍니다.
...
{% include image.html src="/assets/images/post/3/4.png" %}
...
{% include image.html src="/assets/images/post/3/7.png" %}
...
{% include image.html src="/assets/images/post/3/8.png" %}
